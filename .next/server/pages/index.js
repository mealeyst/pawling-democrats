...
/* harmony import */ var _components_Nodes__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6586);
...
/* harmony import */ var _lib_api__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(1895);
/* harmony import */ var next_script__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(4780);
...
async function getStaticProps({ preview =false  }) {
    ...
    const page = (0,_lib_api__WEBPACK_IMPORTED_MODULE_13__/* .extractPage */ .$F)(await apolloClient.query({
    ...
    const navigation = (0,_lib_api__WEBPACK_IMPORTED_MODULE_13__/* .extractNavigationLinks */ .DN)(await apolloClient.query({
...
var __webpack_exports__ = __webpack_require__.X(0, [505,664,322], () => (__webpack_exec__(4186)));
