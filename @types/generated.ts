...
/** Blog posts are added to an overall feed and can be added in a more ad-hoc basis. [See type definition](https://app.contentful.com/spaces/rk57t2u71nbm/content_types/blogPost) */
...
export type BlogPostLinkingCollectionsNavigationMenuCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  order?: InputMaybe<Array<InputMaybe<BlogPostLinkingCollectionsNavigationMenuCollectionOrder>>>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
};

export enum BlogPostLinkingCollectionsNavigationMenuCollectionOrder {
  SlugAsc = 'slug_ASC',
  SlugDesc = 'slug_DESC',
  SysFirstPublishedAtAsc = 'sys_firstPublishedAt_ASC',
  SysFirstPublishedAtDesc = 'sys_firstPublishedAt_DESC',
...
/** [See type definition](https://app.contentful.com/spaces/rk57t2u71nbm/content_types/blogPostOrPage) */
export type BlogPostOrPage = Entry & {
  __typename?: 'BlogPostOrPage';
  body?: Maybe<BlogPostOrPageBody>;
  contentfulMetadata: ContentfulMetadata;
  linkedFrom?: Maybe<BlogPostOrPageLinkingCollections>;
  slug?: Maybe<Scalars['String']['output']>;
  sys: Sys;
  title?: Maybe<Scalars['String']['output']>;
};
...
/** [See type definition](https://app.contentful.com/spaces/rk57t2u71nbm/content_types/blogPostOrPage) */
export type BlogPostOrPageBodyArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
};


/** [See type definition](https://app.contentful.com/spaces/rk57t2u71nbm/content_types/blogPostOrPage) */
export type BlogPostOrPageLinkedFromArgs = {
  allowedLocales?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
};


/** [See type definition](https://app.contentful.com/spaces/rk57t2u71nbm/content_types/blogPostOrPage) */
export type BlogPostOrPageSlugArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
};


/** [See type definition](https://app.contentful.com/spaces/rk57t2u71nbm/content_types/blogPostOrPage) */
export type BlogPostOrPageTitleArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
};

export type BlogPostOrPageBody = {
  __typename?: 'BlogPostOrPageBody';
  json: Scalars['JSON']['output'];
  links: BlogPostOrPageBodyLinks;
};

export type BlogPostOrPageBodyAssets = {
  __typename?: 'BlogPostOrPageBodyAssets';
  block: Array<Maybe<Asset>>;
  hyperlink: Array<Maybe<Asset>>;
};

export type BlogPostOrPageBodyEntries = {
  __typename?: 'BlogPostOrPageBodyEntries';
  block: Array<Maybe<Entry>>;
  hyperlink: Array<Maybe<Entry>>;
  inline: Array<Maybe<Entry>>;
};

export type BlogPostOrPageBodyLinks = {
  __typename?: 'BlogPostOrPageBodyLinks';
  assets: BlogPostOrPageBodyAssets;
  entries: BlogPostOrPageBodyEntries;
  resources: BlogPostOrPageBodyResources;
};

export type BlogPostOrPageBodyResources = {
  __typename?: 'BlogPostOrPageBodyResources';
  block: Array<ResourceLink>;
};

export type BlogPostOrPageCollection = {
  __typename?: 'BlogPostOrPageCollection';
  items: Array<Maybe<BlogPostOrPage>>;
  limit: Scalars['Int']['output'];
  skip: Scalars['Int']['output'];
  total: Scalars['Int']['output'];
};

export type BlogPostOrPageFilter = {
  AND?: InputMaybe<Array<InputMaybe<BlogPostOrPageFilter>>>;
  OR?: InputMaybe<Array<InputMaybe<BlogPostOrPageFilter>>>;
  body_contains?: InputMaybe<Scalars['String']['input']>;
  body_exists?: InputMaybe<Scalars['Boolean']['input']>;
  body_not_contains?: InputMaybe<Scalars['String']['input']>;
  contentfulMetadata?: InputMaybe<ContentfulMetadataFilter>;
...
export type BlogPostOrPageLinkingCollections = {
  __typename?: 'BlogPostOrPageLinkingCollections';
  entryCollection?: Maybe<EntryCollection>;
};


export type BlogPostOrPageLinkingCollectionsEntryCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
...
/** [See type definition](https://app.contentful.com/spaces/rk57t2u71nbm/content_types/card) */
...
export type CardLinkingCollectionsDeckCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  order?: InputMaybe<Array<InputMaybe<CardLinkingCollectionsDeckCollectionOrder>>>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
};
...
export enum CardLinkingCollectionsDeckCollectionOrder {
...
/** A deck contains one or more cards and controls how they are rendered. [See type definition](https://app.contentful.com/spaces/rk57t2u71nbm/content_types/deck) */
export type Deck = Entry & {
  __typename?: 'Deck';
  cardsCollection?: Maybe<DeckCardsCollection>;
...
/** A deck contains one or more cards and controls how they are rendered. [See type definition](https://app.contentful.com/spaces/rk57t2u71nbm/content_types/deck) */
export type DeckCardsCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  order?: InputMaybe<Array<InputMaybe<DeckCardsCollectionOrder>>>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
...
export type DeckCardsCollection = {
  __typename?: 'DeckCardsCollection';
  items: Array<Maybe<Card>>;
  limit: Scalars['Int']['output'];
  skip: Scalars['Int']['output'];
  total: Scalars['Int']['output'];
...
export enum DeckCardsCollectionOrder {
  SysFirstPublishedAtAsc = 'sys_firstPublishedAt_ASC',
  SysFirstPublishedAtDesc = 'sys_firstPublishedAt_DESC',
  SysIdAsc = 'sys_id_ASC',
  SysIdDesc = 'sys_id_DESC',
...
export type DeckFilter = {
  AND?: InputMaybe<Array<InputMaybe<DeckFilter>>>;
  OR?: InputMaybe<Array<InputMaybe<DeckFilter>>>;
...
/** [See type definition](https://app.contentful.com/spaces/rk57t2u71nbm/content_types/hero) */
export type Hero = Entry & {
  __typename?: 'Hero';
  contentRegion?: Maybe<HeroContentRegion>;
  contentfulMetadata: ContentfulMetadata;
...
/** [See type definition](https://app.contentful.com/spaces/rk57t2u71nbm/content_types/hero) */
export type HeroContentRegionArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
};


/** [See type definition](https://app.contentful.com/spaces/rk57t2u71nbm/content_types/hero) */
export type HeroHeroImageArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
};
...
export type HeroContentRegion = {
  __typename?: 'HeroContentRegion';
  json: Scalars['JSON']['output'];
  links: HeroContentRegionLinks;
};

export type HeroContentRegionAssets = {
  __typename?: 'HeroContentRegionAssets';
  block: Array<Maybe<Asset>>;
  hyperlink: Array<Maybe<Asset>>;
};

export type HeroContentRegionEntries = {
  __typename?: 'HeroContentRegionEntries';
  block: Array<Maybe<Entry>>;
  hyperlink: Array<Maybe<Entry>>;
  inline: Array<Maybe<Entry>>;
};

export type HeroContentRegionLinks = {
  __typename?: 'HeroContentRegionLinks';
  assets: HeroContentRegionAssets;
  entries: HeroContentRegionEntries;
  resources: HeroContentRegionResources;
};

export type HeroContentRegionResources = {
  __typename?: 'HeroContentRegionResources';
  block: Array<ResourceLink>;
};
...
export type HeroFilter = {
  ...
  contentRegion_contains?: InputMaybe<Scalars['String']['input']>;
  contentRegion_exists?: InputMaybe<Scalars['Boolean']['input']>;
  contentRegion_not_contains?: InputMaybe<Scalars['String']['input']>;
  contentfulMetadata?: InputMaybe<ContentfulMetadataFilter>;
...
/** [See type definition](https://app.contentful.com/spaces/rk57t2u71nbm/content_types/navigationMenu) */
...
export type NavigationMenuMenuItemsCollectionArgs = {
  ...
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<BlogPostOrPageFilter>;
};


/** [See type definition](https://app.contentful.com/spaces/rk57t2u71nbm/content_types/navigationMenu) */
export type NavigationMenuSlugArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
};


/** [See type definition](https://app.contentful.com/spaces/rk57t2u71nbm/content_types/navigationMenu) */
export type NavigationMenuTitleArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
};
...
export type NavigationMenuFilter = {
  ...
  contentfulMetadata?: InputMaybe<ContentfulMetadataFilter>;
  menuItems?: InputMaybe<CfBlogPostOrPageNestedFilter>;
...
export type NavigationMenuMenuItemsItem = BlogPost | Page;
...
/** [See type definition](https://app.contentful.com/spaces/rk57t2u71nbm/content_types/page) */
...
export type PageLinkingCollectionsNavigationMenuCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  order?: InputMaybe<Array<InputMaybe<PageLinkingCollectionsNavigationMenuCollectionOrder>>>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
};

export enum PageLinkingCollectionsNavigationMenuCollectionOrder {
  SlugAsc = 'slug_ASC',
  SlugDesc = 'slug_DESC',
  SysFirstPublishedAtAsc = 'sys_firstPublishedAt_ASC',
  SysFirstPublishedAtDesc = 'sys_firstPublishedAt_DESC',
...
export type Query = {
  ...
  blogPostOrPage?: Maybe<BlogPostOrPage>;
  blogPostOrPageCollection?: Maybe<BlogPostOrPageCollection>;
  card?: Maybe<Card>;
  cardCollection?: Maybe<CardCollection>;
  deck?: Maybe<Deck>;
  deckCollection?: Maybe<DeckCollection>;
...
export type QueryBlogPostOrPageArgs = {
  id: Scalars['String']['input'];
  locale?: InputMaybe<Scalars['String']['input']>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
};
...
export type QueryBlogPostOrPageCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
...
export type QueryDeckCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  order?: InputMaybe<Array<InputMaybe<DeckOrder>>>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<DeckFilter>;
};
...
export type CfBlogPostOrPageNestedFilter = {
  AND?: InputMaybe<Array<InputMaybe<CfBlogPostOrPageNestedFilter>>>;
  OR?: InputMaybe<Array<InputMaybe<CfBlogPostOrPageNestedFilter>>>;
  body_contains?: InputMaybe<Scalars['String']['input']>;
  body_exists?: InputMaybe<Scalars['Boolean']['input']>;
  body_not_contains?: InputMaybe<Scalars['String']['input']>;
  contentfulMetadata?: InputMaybe<ContentfulMetadataFilter>;
